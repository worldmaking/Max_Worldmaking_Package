...
void *calibratecamera_new(t_symbol *s, long argc, t_atom *argv) {
	...
	if (x = (t_calibratecamera *)object_alloc(maxclass)) {
...
{
	t_class *c = class_new("al.calibratecamera", (method)calibratecamera_new, (method)calibratecamera_free, (long)sizeof(t_calibratecamera), 0L, A_GIMME, 0);
